    ...
    <section className="relative h-[92vh] w-full overflow-hidden bg-black text-white">
      ...
      <nav className="relative z-10 mx-auto flex max-w-7xl items-center justify-between gap-6 px-6 pt-6">
        ...
        <div className="hidden items-center gap-6 md:flex text-sm">
          ...
          <a href="#security" className="text-white/90 hover:text-white">Trust & Security</a>
        </div>
        <div className="flex items-center gap-3">
      ...
      <div className="relative z-10 mx-auto flex h-full max-w-4xl flex-col items-center justify-center px-6 pb-20 text-center">
